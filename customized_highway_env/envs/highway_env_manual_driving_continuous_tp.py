...
from customized_highway_env.envs.common.graphics import EnvViewer_vertical_tp
import time
...
class HighwayEnv_manual_continuous_tp(AbstractEnv_original):
    ...
    def render(self, mode: str = 'human'):
        ...
        if self.viewer is None:
            self.viewer = EnvViewer_vertical_tp(self, self.ratio)
...
register(
    id='highway_manual_continuous_tp-v0',
    entry_point='customized_highway_env.envs:HighwayEnv_manual_continuous_tp',
)
