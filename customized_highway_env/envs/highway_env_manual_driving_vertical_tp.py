...
class HighwayEnv_manual_vertical_tp(AbstractEnv_original):
...
register(
    id='highway_manual_vertical_tp-v0',
    entry_point='customized_highway_env.envs:HighwayEnv_manual_vertical_tp',
)
