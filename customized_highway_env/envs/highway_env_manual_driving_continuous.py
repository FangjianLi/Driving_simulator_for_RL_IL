...
class HighwayEnv_manual_continuous(AbstractEnv_original):
...
register(
    id='highway_manual_continuous-v0',
    entry_point='customized_highway_env.envs:HighwayEnv_manual_continuous',
)
