...
class HighwayEnv_manual_vertical_carla(AbstractEnv_original):
    ...
    def update_visual_carla(self):
        ...
        for car_carla, car_x, car_y, car_yaw in zip(self.carla_visualizer.car_list, corrected_carla_x_list,
                                                    corrected_carla_y_list, corrected_carla_heading_list):
...
register(
    id='highway_manual_vertical_carla-v0',
    entry_point='customized_highway_env.envs:HighwayEnv_manual_vertical_carla',
)
